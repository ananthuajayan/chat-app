      ...
      <div className="md:w-1/3 w-full h-full rounded-sm gap-4 flex flex-col">
        <div
          className={`flex w-full justify-between ${
            modes === "light" ? "bg-black" : "bg-slate-200"
        ...
        <div className="w-full relative">
          <input
            type="text"
            className={`w-full p-4 pl-14 rounded-lg outline-none ${
              modes === "light" ? "bg-black text-slate-200" : "bg-slate-200"
            }`}
          />
          <svg
        ...
        <div
          className={` ${
            modes === "light" ? "bg-black" : "bg-slate-200"
          }  h-full p-2 rounded-lg overflow-y-auto custom-scrollbar`}
        >
          {ConvoList.map((list, index) => (
            <div
              key={index}
              className={`p-3 ${
                modes === "light" ? "hover:bg-slate-700" : "hover:bg-slate-300"
              } rounded-md flex items-center gap-4 align-items: center; justify-between`}
            >
                ...
                <div>
                  <h3
                    className={`font-medium ${
                      modes === "light" ? "text-slate-200" : "text-black"
                    }`}
                  >
                    {list.name}
                  </h3>
